  ...
  <div v-show="true">
    <el-form :inline="true" :model="searchForm" label-width="100px" class="searchForm" >
      <el-row>
        ...
        <el-col :span="5">
            <el-button class="qclass" icon="el-icon-search" type="primary" @click="getThreeColorList" :style="{ display: veQue }">查询</el-button>
        </el-col>
    </el-row>
    <el-row>
        <el-col :span="2">
...
-->
        ...
        label="操作">
            <template slot-scope="scope">
                <el-button @click.native.prevent="threeDetailClick(scope.$index, tableData)" type="primary" style="padding:5px;" :style="{ display: veQue }">
                    详情
                </el-button>
...
export default {
  ...
  methods: {
    ...
    threeModifyClick(index, rows){
        ...
        this.$refs.threeModifyRef.form.coVenuesId = this.tableData[index].venuesName;
    ...
    deleteData(index, rows){
        ...
        this.$axios.post('/color/delete/' + coId)
        .then(successResponse => {
            let data=successResponse.data;
            if (data.code === 200) {
                this.getThreeColorList();
